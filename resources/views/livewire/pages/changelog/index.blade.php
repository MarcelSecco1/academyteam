                ...
                <div
                    ...
                    <div class="p-10 pt-4">
                        ...
                        <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Lorem ipsum dolor sit amet, consectetur
                            adipiscing elit. In gravida justo et nulla efficitur, maximus egestas sem pellentesque.</p>
                    </div>
                </div>
                <div
            ...
            <div class="relative lg:col-span-2">
                ...
                <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                    ...
                    <div class="p-10 pt-4">
                        ...
                        <p class="mt-2 text-lg/7 font-medium tracking-tight text-gray-950">Connect your favorite tools
                        </p>
                        <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Maecenas at augue sed elit dictum vulputate, in
                            nisi aliquam maximus arcu.</p>
                    </div>
                </div>
            ...
            <div class="relative lg:col-span-2">
                ...
                <div
                    ...
                    <div class="p-10 pt-4">
                        ...
                        <p class="mt-2 max-w-lg text-sm/6 text-gray-600">Aenean vulputate justo commodo auctor vehicula
                            in malesuada semper.</p>
                    </div>
                </div>
                <div
